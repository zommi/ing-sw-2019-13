...
public class VortexCannonCommand implements Command {
    ...
    public ArrayList<ArrayList<Character>> execute(Map.NoSpawnSquare square) { //in this case the square is NOT THE SQUARE OF THE PERSON SHOOTING, BUT THE SQUARE OF THE FIRST PERSON CHOSEN. SEE THE RULES OF THE WEAPONS PLEASE

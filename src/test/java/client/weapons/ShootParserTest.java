...
//
//
//        PlayerAbstract player1 = new ConcretePlayer("player1", gameBoard, Figure.DESTRUCTOR);
//        PlayerAbstract player2 = new ConcretePlayer("player2", gameBoard, Figure.BANSHEE);
//        PlayerAbstract player3 = new ConcretePlayer("player3", gameBoard, Figure.DOZER);
//        PlayerAbstract player4 = new ConcretePlayer("player4", gameBoard, Figure.SPROG);
//        PlayerAbstract player5 = new ConcretePlayer("player5", gameBoard, Figure.VIOLET);
//
